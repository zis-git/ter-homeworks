...
""
# Скопируйте в personal.auto.tfvars и подставьте СВОИ значения

cloud_id  = "b1g***************"
folder_id = "b1f***************"

# Используете один из способов аутентификации:
service_account_key_file = "key.json"
# yc_token = "y0_AgAAA..." # если работаете через OAuth токен

ssh_user       = "ubuntu"
ssh_public_key = "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABAQDMY... user@host"

# При необходимости можно переопределить зоны/подсети/ВМ
# subnets = { ... }
# vms     = { ... }
""
